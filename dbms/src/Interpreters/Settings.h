...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingUInt64, fine_grained_join_mode, 2, "0 for not support; 1 for build side only; 2 for build & prob both")                                                                                                                    \
    M(SettingBool, enable_scatter_memory_reuse, false, "Enable scatter memory reuse")                                                                                                                                                   \
    M(SettingBool, enable_concat_non_joined_stream_with_probe_stream, true, "Enable Join Output don't break data partitions")                                                                                                          \
