...
#define APPLY_FOR_SETTINGS(M)                                                                                                                                                                                                           \
    ...
    M(SettingUInt64, dt_checksum_frame_size, DBMS_DEFAULT_BUFFER_SIZE, "Frame size for delta tree stable storage")                                                                                                                      \
                                                                                                                                                                                                                                        \
    M(SettingDouble, dt_storage_blob_heavy_gc_valid_rate, 0.5, "Max valid rate of deciding a blob can be compact")                                                                                                                      \
    ...
    M(SettingUInt64, fine_grained_join_mode, 0, "0 for not support; 1 for build side only; 2 for build & prob both")                                                                                                                    \
    M(SettingBool, enable_scatter_memory_reuse, false, "Enable scatter memory reuse")                                                                                                                                                   \
    M(SettingBool, enable_concat_non_joined_stream_with_probe_stream, false, "Enable Join Output don't break data partitions")                                                                                                          \
    M(SettingBool, enable_fine_grained_agg, false, "Enable fine grained aggregation")                                                                                                                                                   \
    ...
    M(SettingUInt64, manual_compact_more_until_ms, 60000, "Continuously compact more segments until reaching specified elapsed time. If 0 is specified, only one segment will be compacted each round.")                                \
                                                                                                                                                                                                                                        \
    M(SettingBool, enable_planner, false, "Enable planner")
// clang-format on
